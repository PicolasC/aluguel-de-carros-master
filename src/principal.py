    ...
    while True:
        ...
        if opcao == 1: # Relatórios
            ...
            while repeticao.lower() == "s":
                ...
                repeticao = input("Desejaria inserir mais um registro? [S ou N]:")
                while repeticao.lower() != 's' and repeticao.lower() != 'n':
                    #Pro usuário ser esforçado a escrever N para sair
            ...
            while repeticao.lower() == "s":
                ...
                repeticao = input("Desejaria atualizar mais um registro? [S ou N]:")
                while repeticao.lower() != 's' and repeticao.lower() != 'n':
                    #Pro usuário ser esforçado a escrever N para sair
                    print(f"Escolha inválida! tente novamente")
                    repeticao = input("Desejaria atualizar mais um registro? [S ou N]:")
            ...
            while repeticao.lower() == "s":
                ...
                repeticao = input("Desejaria excluir mais um registro? [S ou N]:")
                while repeticao.lower() != 's' and repeticao.lower() != 'n':
                    #Pro usuário ser esforçado a escrever N para sair
                    print(f"Escolha inválida! tente novamente")
                    repeticao = input("Desejaria excluir mais um registro? [S ou N]:")
